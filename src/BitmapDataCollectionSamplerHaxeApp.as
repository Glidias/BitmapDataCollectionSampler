...
public class BitmapDataCollectionSamplerHaxeApp extends Sprite {
    ...
    private var gridPreview:BitmapDataCollectionSamplerHaxe;
    ...
    public function BitmapDataCollectionSamplerHaxeApp()
    {
        configureStage();
    ...
    protected function init():void
    {
		...
		previewDisplay.bitmapData = gridPreview.getBitmapData();
		gridPreview.sample(0);
	...
	*/
    ...
    private function onEnterFrame(event:Event=null):void {
        ...
        var s:Number = gridPreview.getTotalLength();
		...
		gridPreview.sample(sampleArea.x);
    ...
    private function createMouseScrollBehavior():void {
        mouseScrollBehavior = new MouseScrollBehavior(sampleArea, gridPreview.getTotalLength() );
    ...
    private function createGridSampler():void {
        ...
        gridPreview = new BitmapDataCollectionSamplerHaxe();
		gridPreview.init(layers, sampleArea);

		
		// cleanup
		//for each( var bmpData:BitmapData in layers) {
		//	bmpData.dispose();
		//}
		layers = null;
